  ...
  return createPortal(
    ...
    >
      <TableMenu
        ...
        triggerClassName="flex h-2 w-6 items-center justify-center rounded-full bg-brand-500 text-white shadow-sm transition-colors hover:bg-brand-600"
  ...
  return (
    <>
      ...
      <tr style={{ height: rowHeight }}>
        {selectable ? (
          <th className="sticky top-0 z-10 border-neutral-100 border-b bg-neutral-50">
        ...
        {columns.map((column, index) => {
          ...
          return (
            <th
              ...
              className={cn(
                "group sticky top-0 z-10 border-neutral-100 border-b bg-neutral-50 p-0 font-medium text-neutral-600",
                "data-[drop=true]:before:absolute data-[drop=true]:before:inset-y-0 data-[drop=true]:before:left-0 data-[drop=true]:before:w-0.5 data-[drop=true]:before:bg-brand-500",
                "data-[dropend=true]:after:absolute data-[dropend=true]:after:inset-y-0 data-[dropend=true]:after:right-0 data-[dropend=true]:after:w-0.5 data-[dropend=true]:after:bg-brand-500",
              )}
            >
              <motion.div
                className={cn(
              ...
              {resizable ? (
                <button
                  ...
                  className="absolute top-0 right-0 h-full w-1.5 cursor-col-resize touch-none bg-transparent transition-colors hover:bg-brand-500/40"
                />
              ) : null}
            </th>
          );
        ...
        <th
          aria-hidden
          className="sticky top-0 z-10 border-neutral-100 border-b bg-neutral-50"
        />
      </tr>
    </thead>
    </>
