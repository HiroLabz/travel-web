      ...
      >
        ...
        >
          {item.icon ? (
            <span
              className={cn(
                "grid h-7 w-7 shrink-0 place-items-center text-neutral-600",
                classNames?.icon,
              )}
            >
              {item.icon}
          ...
          <span
            className={cn(
              "min-w-0 flex-1 truncate text-[15px] font-medium text-neutral-dark-900",
              classNames?.title,
            )}
          >
            {item.title}
          ...
          <motion.span
            ...
            className={cn(
              "grid h-6 w-6 shrink-0 place-items-center text-neutral-600",
              classNames?.chevron,
            )}
          >
        ...
        >
          ...
          >
            <div
              className={cn(
                "text-[15px] leading-6 text-neutral-600",
