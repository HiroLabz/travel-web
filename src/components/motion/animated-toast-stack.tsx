...
// Icon-wrap tint per status.
const STATUS_CLASS: Record<ToastStatus, string> = {
  neutral: "text-neutral-600 bg-neutral-50",
  info: "text-secondary-500 bg-brand-subtle",
  loading: "text-secondary-500 bg-brand-subtle",
  success: "text-success-600 bg-success-50",
  error: "text-danger-500 bg-danger-50",
};

// Whole-card bg/border/text per status — matches DESIGN.md's Toast spec
// (Error/Info/Success/Warning each get their own tinted surface).
const STATUS_SURFACE_CLASS: Record<ToastStatus, string> = {
  neutral: "border-neutral-100 bg-white",
  info: "border-secondary-500 bg-brand-subtle",
  loading: "border-secondary-500 bg-brand-subtle",
  success: "border-success-600 bg-success-50",
  error: "border-danger-600 bg-danger-50",
};

// Title/description text color per status, per DESIGN.md's Toast spec.
const STATUS_TEXT_CLASS: Record<ToastStatus, string> = {
  neutral: "text-neutral-dark-900",
...
const ToastItem = memo(function ToastItem({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-[4px] border p-3 shadow-s",
